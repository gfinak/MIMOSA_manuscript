...
%\subsection{Parameter estimation}
We again make use of the marginal likelihoods in closed form (see Appendix C of the Supplementary Material). 
...
We have shown elsewhere that changes in both the frequency of expression and expression level are informative~{McDavid2012}, and extensions of the model that incorporate the continuous component (MFI or gene expression) are warranted in the future. 
