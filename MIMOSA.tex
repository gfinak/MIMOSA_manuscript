...
\begin{tikzpicture}
    ...
    \node[anchor=south west, inner sep=0] at (0,-3.75){\includegraphics[width=.6\columnwidth]{Figures/12}};
...
\node[anchor=south west, inner sep=0] at (9.1,0) {\includegraphics[width=0.29\columnwidth]{Figures/Fluidigm_plot3.pdf}};
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=.3\columnwidth]{Figures/simulations_onesided_AUCS.pdf}};    \node[anchor=south west, inner sep=0] at (4.5,0){\includegraphics[width=0.3\columnwidth]{Figures/simulations_twosided_AUC.pdf}};   \node[anchor=south west, inner sep=0] at (9,0) {\includegraphics[width=0.3\columnwidth]{Figures/simulations_onesided_ROC.pdf}};   \node[anchor=south west, inner sep=0] at (0,-3.5){\includegraphics[width=0.3\columnwidth]{Figures/simulations_twosided_ROC.pdf}};   \node[anchor=south west, inner sep=0] at (4.5,-3.5){\includegraphics[width=0.3\columnwidth]{Figures/simulations_onesided_FDR.pdf}};   \node[anchor=south west, inner sep=0] at (9,-3.5){\includegraphics[width=0.3\columnwidth]{Figures/simulations_twosided_FDR.pdf}};
    \node at (0,3.4) [font=\tiny\sffamily] {A} ;
    \node at (4.6,3.4) [font=\tiny\sffamily] {B} ;
    \node at (9,3.4) [font=\tiny\sffamily] {C} ;
    \node at (0,-0.25) [font=\tiny\sffamily] {D} ;
    \node at (4.6,-0.25) [font=\tiny\sffamily] {E} ;
    \node at (9,-0.25) [font=\tiny\sffamily] {F} ;
\end{tikzpicture}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=0.3\columnwidth]{Figures/Sim_Trunc_AUC.pdf}};    \node[anchor=south west, inner sep=0] at (4.5,0) {\includegraphics[width=0.3\columnwidth]{Figures/Sim_Trunc_ROC.pdf}};   \node[anchor=south west, inner sep=0] at (9,0) {\includegraphics[width=0.3\columnwidth]{Figures/Sim_Trunc_FDR.pdf}};    \node at (0,3.4) [font=\tiny\sffamily] {A} ;
    \node at (4.6,3.4) [font=\tiny\sffamily] {B} ;
    \node at (9,3.4) [font=\tiny\sffamily] {C} ;
 \end{tikzpicture}
   \caption{Unconstrained MIMOSA model fit to data where model assumptions are violated. Two--sided data were simulated from a model where the proportions were drawn from a truncated normal distribution over $[0,1]$, rather than a Beta distribution.}
...
\begin{figure}[htbp] %  figure placement: here, top, bottom, or page
   \centering
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=.3\columnwidth]{Figures/Multivariate_Sims_AUCBOX.pdf}};    \node[anchor=south west, inner sep=0] at (4.5,0){\includegraphics[width=0.3\columnwidth]{Figures/Multivariate_Sims_FDR.pdf}};   \node[anchor=south west, inner sep=0] at (9,0) {\includegraphics[width=0.3\columnwidth]{Figures/Multivariate_Sims_ROC.pdf}};    \node at (0,2.1) [font=\tiny\sffamily] {A} ;
    \node at (4.5,2.1) [font=\tiny\sffamily] {B} ;
    \node at (9,2.1) [font=\tiny\sffamily] {C} ;
\end{tikzpicture}
...
%   \includegraphics[width=.75\columnwidth]{Figures/12} 
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) {\includegraphics[width=.5\columnwidth]{Figures/1}};
