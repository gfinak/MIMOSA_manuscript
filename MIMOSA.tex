...
Details about the algorithms are given in Web Appendix A. We used the
...
than about 500,000 iterations with 50,000 burn-in iterations (thinning
interval of 50) was sufficient to estimate standard posterior quantities. To leave some margin, we used 1,000,000 iterations after 50,000 burn-in iterations for each dataset explored here.
