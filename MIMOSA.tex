...
Individual cells are labelled using fluorescently conjugated antibodies against phenotypic biomarkers (CD3, CD4, and CD8), used to subset T-cells, and functional biomarkers (cytokines) used to define antigen specific T-cells~\citep{Horton:2007tsa,DeRosa:2004wp,Betts:2006dw}.
...
Although the immunological experiments described above will often look at multiple antigens or stimulations, in the models presented here we consider only one stimulation (i.e. antigen or condition) at a time vs. unstimulated. The issue of multiple antigens is handled through multiple testing correction. 
...
\subsection{Priors}
\label{ss:priors}
Our model shares information across all subjects using exchangeable~\citep{Bernardo:1996tl} Beta priors on the unknown proportions, as follows: 
 \begin{align*}
...
\node at (0,0) (A){
    \begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) (foo) {\includegraphics[width=0.95\columnwidth]{Figures/2.ps}};
...
\end{tikzpicture}
 ...
 \node [below=of A] (B) {
 \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (bar){\includegraphics[width=0.95\columnwidth]{Figures/1.ps}};
  ...
  \node [below=of B] (E) {
 \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (baz){\includegraphics[width=0.95\columnwidth]{Figures/15.ps}};
...
\node at (0,0) (A) {
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] at (0,0) (foo) {\includegraphics[width=0.45\columnwidth]{Figures/Fluidigm_plot1.ps}};
\begin{scope} [x={(foo.south east)},y={(foo.north west)}]
\node at (0,1) [font=\tiny\sffamily] {A} ;
\end{scope}
\end{tikzpicture}
...
\node [right=of A] (B) {
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] at (0,0) (bar) {\includegraphics[width=0.45\columnwidth]{Figures/Fluidigm_plot2.ps}};
\begin{scope} [x={(bar.south east)},y={(bar.north west)}]
...
\node [below=of A] (C) {
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] at (0,0) (baz) {\includegraphics[width=0.45\columnwidth]{Figures/FluidigmFisher.ps}};
\begin{scope} [x={(baz.south east)},y={(baz.north west)}]
...
\begin{figure} %  figure placement: here, top, bottom, or page
   ...
   \node at (0,0) (A) {
\begin{tikzpicture}
    \node [anchor=south west] at (0,0) (foo) {\includegraphics[width=0.45\columnwidth]{Figures/Sim_Onesided_ROC_5000.ps}};
    \begin{scope}[x={(foo.south east)},y={(foo.north west)}]
        \node at (0,1) [font=\tiny\sffamily] {A} ;
        \end{scope}
    \end{tikzpicture}
    ...
    \node [right=of A] (B) {
    \begin{tikzpicture}
    \node [anchor=south west] at (0,0) (bar) {\includegraphics[width=0.45\columnwidth]{Figures/Sim_Onesided_FDR_5000.ps}};
    \begin{scope}[x={(bar.south east)},y={(bar.north west)}]
    ...
    \end{tikzpicture}
        ...
        \node [below=of A] (C) {
    \begin{tikzpicture}
    \node [anchor=south west] at (0,0) (c) {\includegraphics[width=0.45\columnwidth]{Figures/Sim_Twosided_ROC_5000.ps}};
    ...
    \node [right=of C] (D) {
    \begin{tikzpicture}
    \node [anchor=south west] at (0,0) (d) {\includegraphics[width=0.45\columnwidth]{Figures/Sim_Twosided_FDR_5000.ps}};
...
(\mathbf{p}_{ui}|z_i=1) &\sim \mathrm{Dir}(\boldsymbol{\alpha}_u) \quad \text{and}\quad (\mathbf{p}_{si}|z_i=1) \sim \mathrm{Dir}(\boldsymbol{\alpha}_s),\end{align*}
...
\node at (0,0) (A) {
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] at (0,0) (foo) {\includegraphics[width=0.45\columnwidth]{Figures/Fluidigm_Multivariate_BIRC3_CCL5_Unstim_Counts.ps}};
\begin{scope} [x={(foo.south east)},y={(foo.north west)}]
\node at (0,1) [font=\tiny\sffamily] {A} ;
\end{scope}
\end{tikzpicture}
...
\node [right=of A] (B){
\begin{tikzpicture}
\node[anchor=south west, inner sep=0] at (0,0) (bar) {\includegraphics[width=0.45\columnwidth]{Figures/Fluidigm_Multivariate_BIRC3_CCL5_Stim_Counts.ps}};
\begin{scope} [x={(bar.south east)},y={(bar.north west)}]
...
\node at (0,0) (A) {
\begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (foo) {\includegraphics[width=0.47\columnwidth]{Figures/Multivariate_Sims_ROC_rev.ps}};
\begin{scope} [x={(foo.south east)},y={(foo.north west)}]
    \node at (0,1) [font=\tiny\sffamily] {A} ;
\end{scope}
\end{tikzpicture}
...
\node [right=of A] (B) {
\begin{tikzpicture}
   \node[anchor=south west, inner sep=0] at (0,0) (bar) {\includegraphics[width=0.47\columnwidth]{Figures/Multivariate_Sims_FDR_rev.ps}};
   \begin{scope} [x={(bar.south east)},y={(bar.north west)}]
       \node at (0,1) [font=\tiny\sffamily] {B} ;
\end{scope}
\end{tikzpicture}
