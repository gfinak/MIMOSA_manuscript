...
\title{Web-based Supplementary Materials for Mixture Models for Single-Cell Assays with Application to Vaccine Studies by Greg Finak, Andrew McDavid, Pratip Chattopadhyay, Maria Dominguez, Steve De Rosa, Mario Roederer and Raphael Gottardo}
...
\begin{tikzpicture} [auto, node distance=0cm]
 \node at (0,) (A) {
 \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (b) {\includegraphics[width=.5\columnwidth]{Figures/3.ps}};
 ...
 \node [right=of A] (B) {
 \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (c) {\includegraphics[width=.5\columnwidth]{Figures/5.ps}};
...
\node [below=of A] (C) {
\begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (d) {\includegraphics[width=.5\columnwidth]{Figures/6.ps}};
...
\node [right=of C] (D) {
\begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (e) {\includegraphics[width=.5\columnwidth]{Figures/7.ps}};
        \begin{scope}[x={(d.south east)},y={(d.north west)}]
...
%    };
    \node at (0,0) (A) {
    \begin{tikzpicture}
     \node[anchor=south west,inner sep=0] at (0,0) (c) {\includegraphics[width=0.4\columnwidth]{Figures/Sim_Truncated_ROC_5000.ps}};
         \begin{scope} [x={(c.south east)},y={(c.north west)}]
                 \node at (0,1) [font=\tiny\sffamily] {A} ;
	\end{scope}
     \end{tikzpicture}
     ...
     \node [right=of A] (B) {
     \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (d) {\includegraphics[width=0.4\columnwidth]{Figures/Sim_Truncated_FDR_5000.ps}};
        \begin{scope} [x={(d.south east)},y={(d.north west)}]
            \node at (0,1) [font=\tiny\sffamily] {B} ;
\end{scope}
    \end{tikzpicture}
  ...
  \node [below=of A] (C) {
\begin{tikzpicture}
    \node[anchor=south west,inner sep=0] at (0,0) (e) {\includegraphics[width=0.4\columnwidth]{Figures/Sim_Truncated_ROC_1000.ps}};
    ...
    \node [right=of C] (D) {
    \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (f) {\includegraphics[width=0.4\columnwidth]{Figures/Sim_Truncated_FDR_1000.ps}};
    ...
    \node [below=of C] (E) {
    \begin{tikzpicture}
     \node[anchor=south west,inner sep=0] at (0,0) (g) {\includegraphics[width=0.4\columnwidth]{Figures/Sim_Twosided_ROC_1000.ps}};
	...
	\end{scope}
     ...
     \node [right=of E] (F) {
     \begin{tikzpicture}
    \node[anchor=south west, inner sep=0] at (0,0) (h) {\includegraphics[width=0.4\columnwidth]{Figures/Sim_Twosided_FDR_1000.ps}};
