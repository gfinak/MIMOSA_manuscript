...
```{r heatmap.props.bygene,cache=TRUE,include=FALSE}
...
```{r heatmap.props.bystim.bygene,cache=TRUE,include=FALSE}
colnames(props)<-colnames(S)
rownames(props)<-rownames(S)
...
```{r simulations,cache=FALSE,echo=FALSE,fig.width=5,fig.height=5,include=FALSE}
...
```{r two.sided.sims, cache=FALSE, echo=FALSE,fig.width=5,fig.height=5,include=FALSE}
...
```{r violated.assumptions, cache=FALSE,echo=FALSE,fig.width=20,fig.height=10}
